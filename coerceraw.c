...
void prtusage(void)
{
	printf("coercewav ... takes any file and generates vrious wavs with different palusible characteristics\n");
	printf("One argument required .. the name of the input file\n");
	exit(EXIT_FAILURE);
}
