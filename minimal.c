...
int main(int argc, char *argv[])
{
  ...
  splt_point *p1 = mp3splt_point_new(100 * 60 *6 , NULL); // 1st: splitpt value hundreths of a sec , 2nd error code
  mp3splt_append_splitpoint(state, p1);
  splt_point *p2 = mp3splt_point_new(100 * 60 * 9, NULL);
  mp3splt_append_splitpoint(state, p2);
