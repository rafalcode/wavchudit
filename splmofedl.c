/* splmofedl, takes an mp3/ogg and then and edl file and extracts the chunk ebfore the first marked point,
 * the part between the marked points and the chunk corresponding to final time mark to the end of the file */
