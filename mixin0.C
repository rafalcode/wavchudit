/* OK in Jan 2023 I was parsing colour codes and I made the dreadful misjudgement of 
 * making a new repository for it, called colgive on rafbb.
 * Weeks later the memory of the effort stuck, but the name didn't ... then I went 
 * through the horrible experience of going through my copybook notes.
 * Wow, that name was not mentioned, though I closed in on the day I worked on it 19.01.23
 * so I used the find -mtime trick and got it, but boy was that painful */
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
#include "tablerd.h"
